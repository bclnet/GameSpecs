...
namespace GameSpec.Blizzard.Formats.Casc
{
    public class DB3Row
    {
        byte[] m_data;
    ...
    public class WDB3Reader : IEnumerable<KeyValuePair<int, DB3Row>>
    {
        ...
        const uint DB3FmtSig = 0x33424457;          // WDB3
        const uint DB4FmtSig = 0x34424457;          // WDB4
        ...
        SortedDictionary<int, DB3Row> m_index = new SortedDictionary<int, DB3Row>();
