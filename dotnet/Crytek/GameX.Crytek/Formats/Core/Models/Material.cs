...
namespace GameX.Crytek.Formats.Models
{
    ...
    public class Material
    {
        ...
        [XmlAttribute(AttributeName = "MatTemplate")] public string MatTemplate { get; set; }
        [XmlAttribute(AttributeName = "Diffuse")] public string Diffuse { get; set; }
        [XmlAttribute(AttributeName = "Specular")] public string Specular { get; set; }
        [XmlAttribute(AttributeName = "Emissive")] public string Emissive { get; set; }
        [XmlAttribute(AttributeName = "Shininess")] public string Shininess { get; set; }
        [XmlAttribute(AttributeName = "Opacity")] public string Opacity { get; set; }
