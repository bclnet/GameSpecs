...
namespace StereoKit.Maui
{
    public static partial class WindowExtensions
    {
        ...
        public static float GetDisplayDensity(this Window platformWindow)
            => (float)DPExtensions.ScalingFactor;
        ...
        internal static void UpdateX(this Window platformWindow, IWindow window) => platformWindow.UpdateUnsupportedCoordinate(window);

        internal static void UpdateY(this Window platformWindow, IWindow window) => platformWindow.UpdateUnsupportedCoordinate(window);

        internal static void UpdateWidth(this Window platformWindow, IWindow window) => platformWindow.UpdateUnsupportedCoordinate(window);

        internal static void UpdateHeight(this Window platformWindow, IWindow window) => platformWindow.UpdateUnsupportedCoordinate(window);

        internal static void UpdateUnsupportedCoordinate(this Window platformWindow, IWindow window) => window.FrameChanged(platformWindow.WindowPositionSize.ToDP());
    }
}
