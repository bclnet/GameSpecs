...
{
    public abstract partial class SKViewHandler : SKElementHandler, IViewHandler
    {
        ...
        protected SKViewHandler(IPropertyMapper mapper, CommandMapper? commandMapper = null) : base(mapper, commandMapper ?? ViewCommandMapper) { }
