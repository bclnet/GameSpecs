    ...
    public static class Trajectory2
    {
        public static Vector3 CalculateTrajectory(Vector3 startPos, Vector3 endPos, Vector3 targetVelocity, float speed, bool gravity)
        {
            ...
            else
            {
                ...
                if (Vec.NormalizeCheckSmall(ref v0)) v0 = Vector3.Zero;
                ...
                if (t >= 100) return CalculateTrajectory(startPos, endPos, Vector3.Zero, speed, gravity);
            ...
            if (gravity) result.Z -= PhysicsGlobals.Gravity * t * 0.5f;
