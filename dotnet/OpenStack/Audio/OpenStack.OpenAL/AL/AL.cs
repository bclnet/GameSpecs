...
using System.NumericsX.OpenAL.Native;
...
namespace System.NumericsX.OpenAL
{
    ...
    public partial class AL : ALBase
    {
        ...
        */
        ...
        public static unsafe void BufferData<TBuffer>(int bid, ALFormat format, TBuffer[] buffer, int freq) where TBuffer : unmanaged
        {
        ...
        /// <param name="freq">The frequency of the audio buffer.</param>
        public static unsafe void BufferData<TBuffer>(int bid, ALFormat format, Span<TBuffer> buffer, int freq) where TBuffer : unmanaged
        {
            fixed (TBuffer* b = buffer)
                BufferData(bid, format, b, buffer.Length * sizeof(TBuffer), freq);
        }
        ...
        */
        ...
        public static ALDistanceModel GetDistanceModel()
            => (ALDistanceModel)Get(ALGetInteger.DistanceModel);
