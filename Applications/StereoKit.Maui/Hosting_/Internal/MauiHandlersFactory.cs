...
namespace StereoKit.Maui.Hosting.Internal
{
    ...
    {
        public MauiHandlersFactory(IEnumerable<HandlerMauiAppBuilderExtensions.HandlerRegistration> registrationActions) : base(CreateHandlerCollection(registrationActions)) { }
        ...
        private static IMauiServiceCollection CreateHandlerCollection(IEnumerable<HandlerMauiAppBuilderExtensions.HandlerRegistration> registrationActions)
        {
            ...
            Microsoft.Maui.HotReload.MauiHotReloadHelper.RegisterHandlers(collection);
            return collection;
        }
