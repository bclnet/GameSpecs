...
namespace StereoKit.Maui.Platform
{
	public static class FlyoutViewExtensions
	{
		...
		//{
		//	if (behavior == FlyoutBehavior.Disabled) return DrawerBehavior.Disabled;
		//	else if (behavior == FlyoutBehavior.Locked) return DrawerBehavior.Locked;
		//	else return DrawerBehavior.Drawer;
		//}
	}
}
