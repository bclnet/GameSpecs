...
namespace StereoKit.Maui.Platform
{
    public static class EntryExtensions
    {
        ...
        //        _ => throw new System.NotImplementedException($"ReturnType {returnType} not supported"),
        //    };
        ...
        //    switch (alignment)
        //    {
        //        case TextAlignment.Center: return TTextAlignment.Center;
        //        case TextAlignment.Start: return TTextAlignment.Start;
        //        case TextAlignment.End: return TTextAlignment.End;
        //        default:
        //            Log.Warn("Warning: unrecognized HorizontalTextAlignment value {0}. Expected: {Start|Center|End}.", alignment);
