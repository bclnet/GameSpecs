...
namespace GameSpec.Tes.Formats
{
    ...
    public class Header
    {
        ...
        public Header(BinaryReader r, TesFormat format, Header parent)
        {
            ...
            if (Type == "GRUP")
            {
                ...
                if (format != TesFormat.TES4) r.ReadUInt32(); // version + uknown
                Position = r.Position();
                return;
            }
            ...
            FormId = r.ReadUInt32();
            r.ReadUInt32();
            if (format == TesFormat.TES4) { Position = r.Position(); return; }
            // tes5
            r.ReadUInt32();
            Position = r.Position();
        }
    ...
    public partial class RecordGroup
    {
        ...
        readonly TesFormat _format;
        readonly int _recordLevel;
        int _headerSkip;

        public RecordGroup(GenericPoolAction<BinaryReader> poolAction, string filePath, TesFormat format, int recordLevel)
        {
