...
namespace GameSpec.Valve.Formats.Blocks
{
    ...
    {
        public static Dictionary<uint, string> KnownKeys { get; } = new Dictionary<uint, string>();

        static DATAEntityLump()
        {
            ...
            foreach (var field in list) KnownKeys.Add(EntityLumpKeyLookup.Get(field), field);
        }
    }
}
