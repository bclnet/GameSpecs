...
namespace GameSpec.Lith
{
    ...
    public class LithPakFile : BinaryPakManyFile, ITransformFileObject<IUnknownFileModel>
    {
        ...
        public LithPakFile(FamilyGame game, IFileSystem fileSystem, string filePath, object tag = default) : base(game, fileSystem, filePath, GetPakBinary(game, filePath), tag)
        {
