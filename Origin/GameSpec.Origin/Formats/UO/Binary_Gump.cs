...
{
    public unsafe class Binary_Gump : IHaveMetaInfo
    {
        public static Task<object> Factory(BinaryReader r, FileSource f, PakFile s) => Task.FromResult((object)new Binary_Gump(r));
        ...
        public Binary_Gump(BinaryReader r)
        {
        }
