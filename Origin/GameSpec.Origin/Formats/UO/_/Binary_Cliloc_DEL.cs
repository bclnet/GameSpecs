...
{
    public unsafe class Binary_Cliloc_DEL : IHaveMetaInfo
    {
        public static Task<object> Factory(BinaryReader r, FileSource f, PakFile s) => Task.FromResult((object)new Binary_Cliloc_DEL(r));
        ...
        // file: Cliloc.enu
        public Binary_Cliloc_DEL(BinaryReader r)
        {
