...
using System.IO;
using static GameSpec.Epic.Formats.Core.Game;
using static GameSpec.Epic.Formats.Core.ReaderExtensions;
using static GameSpec.Epic.Formats.Core.UDecrypt;
using static GameSpec.Epic.Formats.Core.UPackage;
using static GameSpec.Formats.Compression;

namespace GameSpec.Epic.Formats.Core
{
