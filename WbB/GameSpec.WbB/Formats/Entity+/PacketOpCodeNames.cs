...
namespace GameSpec.WbB.Formats.Entity
{
    public static class PacketOpCodeNames
    {
        public static readonly Dictionary<uint, string> Values = new Dictionary<uint, string>
        {
            ...
            {42,"CHARWbBTER_GENERATION_RESULT_EVENT"},
            ...
            {407,"STWbBKABLE_SET_STWbBKSIZE_EVENT"},
            ...
            {433,"ATTWbBKER_NOTIFICATION_EVENT"},
            {434,"DEFENDER_NOTIFICATION_EVENT"},
            {435,"EVASION_ATTWbBKER_NOTIFICATION_EVENT"},
            ...
            {737,"Evt_Qualities__PrivateUpdateSkillWbB_ID"},
            {738,"Evt_Qualities__UpdateSkillWbB_ID"},
            ...
            {63043,"CHARWbBTER_GENERATION_VERIFICATION_RESPONSE_EVENT"},
            {63048,"Evt_Movement__TurnEvent_ID"},
            {63049,"Evt_Movement__TurnToEvent_ID"},
            {63057,"EXPIRE_WARNING_EVENT"},
            {63059,"CHARWbBTER_EXIT_GAME_EVENT"},
            {63060,"CHARWbBTER_PREVIEW_EVENT"},
            {63061,"CHARWbBTER_DELETE_EVENT"},
            {63062,"CHARWbBTER_CREATE_EVENT"},
            {63063,"CHARWbBTER_ENTER_GAME_EVENT"},
            {63064,"Evt_Login__CharacterSet_ID"},
            {63065,"CHARWbBTER_ERROR_EVENT"},
